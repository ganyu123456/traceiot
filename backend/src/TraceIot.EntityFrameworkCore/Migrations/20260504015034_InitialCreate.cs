...
namespace TraceIot.EntityFrameworkCore.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlarmValue = table.Column<decimal>(type: "numeric(10,4)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastLat = table.Column<decimal>(type: "numeric(10,7)", nullable: true),
                    LastLng = table.Column<decimal>(type: "numeric(10,7)", nullable: true),
                    LastSpeed = table.Column<decimal>(type: "numeric(8,2)", nullable: true),
                    LastDirection = table.Column<decimal>(type: "numeric(6,2)", nullable: true),
                    Remark = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    OverspeedThreshold = table.Column<decimal>(type: "numeric", nullable: false),
                    OfflineTimeoutSec = table.Column<int>(type: "integer", nullable: false),
                    GeofenceEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    GeofenceConfig = table.Column<string>(type: "jsonb", nullable: true),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
